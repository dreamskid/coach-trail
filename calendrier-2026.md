# Calendrier Courses & Périodisation 2026
...
- Travail de seuil en côte (Z3-Z4)
- Séances spécifiques descente (technique + excentrique)
- Marathon-eXpérience : tester la gestion d'allure et la nutrition sur 42km

#### Bloc 3 — Spécifique OCC (juin → 14 juin)
- Sorties longues avec profil OCC (ratio D+/km élevé)
- Enchaînements montée-descente techniques
- Monistrail : dernière répétition générale sur format proche OCC
- Semaine post-Monistrail : récupération complète

#### Bloc 4 — Volume & pic de forme (juil. → mi-août)
- Dernier bloc de charge avant affûtage
- Sortie(s) longue(s) en montagne avec D+ cumulé important
- Séances qualité (seuil, côtes) maintenues mais pas augmentées
- Altitude si possible (acclimatation pour Chamonix)

#### Bloc 5 — Affûtage OCC (mi-août → 27 août)
- **Tapering 10-14 jours**
- Réduction progressive du volume (-40% puis -60%)
- Maintien de quelques intensités courtes pour garder la fraîcheur
- Logistique course : reconnaissance parcours si possible, plan nutrition, matériel
- Arrivée à Chamonix frais, confiant, prêt

---

## Semaines clés à surveiller
...
| S34-S35 (mi-août) | Tapering OCC |
| **S35 (27 août)** | **OCC — JOUR J** |
